...
mkdir -p S3C_logs/cifar_log_dir/${Method}/

python S3C/train.py -project s3c -dataset cifar100  -base_mode 'ft_cos' \
...
2>&1 | tee ./S3C_logs/cifar_log_dir/${Method}/log_lamda_ce_1_lamda_proto_5.txt